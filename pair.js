...
💡 *Whats Next?* 
1️⃣ Explore all the cool features of STEVE-MD.
...
⭐ *Show Some Love!* Give us a ⭐ on GitHub and support the developer of: 👉 [Malvin King GitHub Repo](https://github.com/hunamqlik/STEVE-MD)  

🚀 _Thanks for choosing STEVE-MD — Let the automation begin!_ ✨`;

                    await Malvin.sendMessage(Malvin.user.id, { text: KASHMIRI_TEXT }, { quoted: session });
